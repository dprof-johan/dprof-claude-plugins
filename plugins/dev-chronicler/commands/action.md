...
pick the slug/title and to focus the entry. If you're missing a concrete detail
needed to write a faithful entry (an exact command, an outcome, a number), ask
a brief clarifying question rather than guessing.
